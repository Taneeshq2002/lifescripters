...
app.post("/signup", function (req, res) {
  ...
  const userid = md5(useridnorm); //variable for credentials of signup page
  const passwordnorm = req.body.signuppass;
  const password = md5(passwordnorm);
...
//functino to display results fromm highest votes to lowest votes
